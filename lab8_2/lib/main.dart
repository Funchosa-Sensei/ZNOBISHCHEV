...
class _NewsScreenState extends State<NewsScreen> {
  ...
  Future<List<NewsItem>> fetchNews() async {
    ...
    try {
      ...
      debugPrint('Часть тела ответа: ${response.body.substring(0, 300)} ...');
      ...
      if (response.statusCode == 200) {
        ...
        if (decodedData is List) {
          return decodedData
              ...
              .toList();
        } else if (decodedData is Map && decodedData.containsKey('news')) {
          final List<dynamic> newsArray = decodedData['news'];
          return newsArray
              .map((item) => NewsItem.fromJson(item as Map<String, dynamic>))
              .toList();
        } else {
          debugPrint('Непредвиденная структура данных: $decodedData');
          return [];
        }
      } else {
      ...
      debugPrint('Ошибка в fetchNews: $e\n$stack');
